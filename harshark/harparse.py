...
class HarParse():
    ...
    def parse(self):
        ...
        for entry in har['log']['entries']:
            ...
            self.keyCheck('response_status_text', 'statusText', entry['request'])
            self.keyCheck('response_http_version', 'httpVersion', entry['request'])
            self.keyCheck('response_headers', 'headers', entry['request'])
            self.keyCheck('response_cookies', 'cookies', entry['request'])
            self.keyCheck('response_body', 'content', entry['request'])
            self.keyCheck('response_redirect_url', 'redirectURL', entry['request'])
            self.keyCheck('response_headers_size', 'headersSize', entry['request'])
            self.keyCheck('response_body_size', 'bodySize', entry['request'])
